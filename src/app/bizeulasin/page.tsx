                ...
                <div className="hidden lg:block relative z-10 w-full max-w-lg bg-white opacity-90 p-8 rounded-lg shadow-lg transform hover:scale-105 transition duration-200">
                  <div className=" space-y-3">
                    ...
                    <div className="flex items-center -space-x-2 overflow-hidden">
                      <Image src="https://randomuser.me/api/portraits/women/79.jpg" alt="User" className="w-10 h-10 rounded-full border-2 border-white" />
                      <Image src="https://api.uifaces.co/our-content/donated/xZ4wg2Xj.jpg" alt="User" className="w-10 h-10 rounded-full border-2 border-white" />
                      <Image src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&s=a72ca28288878f8404a795f39642a46f" alt="User" className="w-10 h-10 rounded-full border-2 border-white" />
                      <Image src="https://randomuser.me/api/portraits/men/86.jpg" alt="User" className="w-10 h-10 rounded-full border-2 border-white" />
                      <Image src="https://images.unsplash.com/photo-1510227272981-87123e259b17?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&s=3759e09a5b9fbe53088b23c615b6312e" alt="User" className="w-10 h-10 rounded-full border-2 border-white" />
