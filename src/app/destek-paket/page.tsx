...
import Ücretsiz from '../../img/destekpaket.png';
      ...
      <div className="mx-2 px-2 2xl:mx-24">
        <div className="flex flex-col md:flex-row md:items-start md:gap-8">
          ...
          <div className='hidden md:flex py-4 mb-2 items-center'>
            ...
            <Link href="/destek-paket/destek-ilan-formu" className="bg-red-600 text-white font-semibold py-2 px-8 mx-2 rounded-lg shadow">Satın Al</Link>
          </div>
            ...
            <div className='md:hidden space-x-4 px-4 fixed left-0 right-0 bottom-0 py-4 flex justify-center items-center rounded-t-2xl bg-white shadow-[0_-2px_2px_rgba(0,0,0,0.1)]'>
              ...
              <Link href="/destek-paket/destek-ilan-formu" className="bg-red-600 text-white text-center font-semibold py-2 px-4 rounded-lg flex-1">Satın Al</Link>
            </div>
          </div>
        </div>
      </div>
