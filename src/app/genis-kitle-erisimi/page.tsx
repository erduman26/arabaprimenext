    ...
    <div className="pt-24 2xl:mx-24 2xl:px-2 mx-4 flex">
      <div className="flex-1 mb-12">
        ...
        <div className='mb-6 p-1'>
          <h3 className="text-2xl font-semibold mb-4">Geniş Kitle Erişimi</h3>
            <p className='font-medium'>
              Sosyal medya, özellikle Instagram, doğru kullanıldığında aracınızın tanıtımı için mükemmel bir platform sunar. Biz, geniş ve organik bir kitleye erişim sağlıyoruz. Takipçi sayımız, tamamen ilgi alanlarına göre seçilmiş ve organik olarak büyütülmüş bir topluluktan oluşuyor. Aracınız, bu sayede doğru kişilerin dikkatini çeker.
            </p>
        </div>
        <div className='mb-6 p-1'>
          <h3 className="text-2xl font-semibold mb-4">Organik Takipçi Kitlesi</h3>
            <p className='font-medium'>
        ...
        <div className='mb-6 p-1'>
          <h3 className="text-2xl font-semibold mb-4">Etkileşim Odaklı İçerik Yönetimi</h3>
            <p className='font-medium'>
        ...
        <div className='mb-6 p-1'>
          <h3 className="text-2xl font-semibold mb-4">Viral Potansiyel</h3>
            <p className='font-medium'>
...
export default GenisKitleErisimi;
