...
import Ücretsiz from '../../img/ücretsizpaketdetay.webp';
...
const UcretsizPaket = () => {
  ...
  return (
    <div className="dark:bg-gray-800 py-8 pt-24 lg:pt-32 mb-8">
      <div className="mx-2 px-2 2xl:mx-24">
        <div className="flex flex-col md:flex-row md:items-start md:gap-8">
          {/* Görsel kısmı */}
          <div className="border p-3 lg:p-4 rounded-lg shadow-lg bg-white md:w-96 sm:flex sm:items-center sm:justify-center md:flex-none">
          ...
          <div>
            ...
            <div className='hidden md:block py-4 mb-2'>
              <button className="bg-red-600 text-white font-semibold py-2 px-8 mx-4 rounded-lg shadow">Ücretsiz Edin</button>
            </div>
