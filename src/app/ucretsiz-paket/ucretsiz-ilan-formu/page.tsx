            ...
            <form>
                <h6 className="flex justify-center md:justify-normal text-gray-900 text-base mt-3 mb-6 font-bold">
                  ...
                  <div className='hidden md:block mx-4'>
                    <button type='submit' className='flex items-center justify-center w-full py-4 rounded text-base font-semibold text-white transition-all duration-200 bg-red-600'>İlan Ver</button>
                </div>
...
export default ÜcretsizİlanFormu