...
import { HiMiniChevronRight, HiOutlineQuestionMarkCircle, HiOutlineInformationCircle, HiOutlinePhoneArrowUpRight } from "react-icons/hi2";
          ...
          <div className="h-3/4 px-4 overflow-y-auto">
            <div className="mt-6">
              ...
              <li className="w-full">
                ...
                <li className="w-full">
                  <Link href="/sikcasorulansorular" onClick={handleLinkClick}>
                    <div className="block text-gray-800 bg-white p-3 shadow-md border shadow-gray-300  rounded">
                      <div className='flex items-center'>
                        <HiOutlineQuestionMarkCircle className='mr-3 w-7 h-7'/>
                        <span>Hesabım</span>
